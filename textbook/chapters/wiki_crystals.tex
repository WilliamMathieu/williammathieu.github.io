% section: wiki_crystals
\section{Quartz Crystal Resonators}\label{sec:wiki_crystals}
...
\subsection{The Butterworth–Van Dyke Model}
...
\subsection{Pulling with a Load Capacitor}
