% section: wiki_mri_hardware
\section{MRI Hardware}\label{sec:wiki_mri_hardware}

\input{pedagogy/wiki_mri_hardware_obj}
...
\input{pedagogy/wiki_mri_hardware}
