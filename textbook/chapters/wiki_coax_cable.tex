% section: wiki_coax_cable
\section{Coaxial Cable}\label{sec:wiki_coax_cable}
...
\subsection{Cable Comparison Table}
...
\subsection{Attenuation Scaling with Frequency}
...
\subsection{Power Handling Limits}
