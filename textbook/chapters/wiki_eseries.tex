% section: wiki_eseries
\section{E-Series Standard Component Values}\label{sec:wiki_eseries}

\input{pedagogy/wiki_eseries_obj}
...
\subsection{E6 and E12 Values (first decade)}
...
\subsection{Reading E-Series Values}
...
\subsection{Finding the Nearest Value}
