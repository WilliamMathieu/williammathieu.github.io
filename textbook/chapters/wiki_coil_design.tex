% section: wiki_coil_design
\section{RF Coil Design for MRI}\label{sec:wiki_coil_design}

\input{pedagogy/wiki_coil_design_obj}
...
\subsection{Tuning to Resonance}
...
\input{pedagogy/wiki_coil_design}
