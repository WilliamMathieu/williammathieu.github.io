% section: wiki_amp_stability
\section{Amplifier Stability}\label{sec:wiki_amp_stability}

\input{pedagogy/wiki_amp_stability_obj}
...
\subsection{S-Parameter Determinant (Δ)}
...
\subsection{Rollett Stability Factor K}
...
\subsection{µ-Factor (Edwards-Sinsky)}
...
\subsection{Maximum Available Gain (MAG)}
...
\subsection{Maximum Stable Gain (MSG)}
...
\input{pedagogy/wiki_amp_stability}
