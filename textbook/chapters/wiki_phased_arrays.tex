% section: wiki_phased_arrays
\section{Phased-Array Coils}\label{sec:wiki_phased_arrays}

\input{pedagogy/wiki_phased_arrays_obj}
...
\input{pedagogy/wiki_phased_arrays}
