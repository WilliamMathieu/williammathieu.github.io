% section: wiki_preamplifier_decoupling
\section{Preamplifier Decoupling}\label{sec:wiki_preamplifier_decoupling}
...
\subsection{The Problem: Mutual Inductance}
...
\subsection{Geometric Overlap Decoupling}
