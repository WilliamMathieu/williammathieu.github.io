% chapter: wiki_intermodulation
\chapter{Intermodulation Distortion and IP3}\label{ch:wiki_intermodulation}
...
\section{Third-Order Intercept Point (IP3)}
...
\section{IMD Ratio \& Dynamic Range}
