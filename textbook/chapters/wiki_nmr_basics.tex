% chapter: wiki_nmr_basics
\chapter{NMR Basics}\label{ch:wiki_nmr_basics}
...
\section{Equilibrium Magnetisation}
...
\section{Bloch Equations and Relaxation}
