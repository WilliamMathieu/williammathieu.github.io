% section: wiki_mri_artifacts
\section{MRI Artefacts}\label{sec:wiki_mri_artifacts}
...
\subsection{Gibbs Ringing (Truncation Artifact)}
...
\subsection{Chemical Shift Artifact}
...
\subsection{Susceptibility Artifacts}
...
\subsection{RF Inhomogeneity (B1+ Artifact)}
