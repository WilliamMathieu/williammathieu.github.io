% section: wiki_complex_impedance
\section{Complex Impedance and Reactance}\label{sec:wiki_complex_impedance}

\input{pedagogy/wiki_complex_impedance_obj}
...
\subsection{Phasors and Sinusoidal Steady State}
...
\subsection{Series vs Parallel Equivalents}
...
\subsection{Impedance vs Frequency: What to Expect}
...
\input{pedagogy/wiki_complex_impedance}
