% section: wiki_b1_mapping
\section{B1 Field Mapping}\label{sec:wiki_b1_mapping}

\input{pedagogy/wiki_b1_mapping_obj}
...
\subsection{Why B1 Mapping Matters at High Field}
...
\subsection{Double Angle Method (DAM)}
...
\subsection{Actual Flip Angle Imaging (AFI)}
...
\subsection{Parallel Transmit (pTx)}
...
\input{pedagogy/wiki_b1_mapping}
