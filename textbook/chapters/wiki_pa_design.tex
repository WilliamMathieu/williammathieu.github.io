% section: wiki_pa_design
\section{Power Amplifier Design}\label{sec:wiki_pa_design}
...
\subsection{Drain Efficiency vs Power-Added Efficiency (PAE)}
...
\subsection{1-dB Compression and Saturation}
...
\subsection{Linearity Requirements by Modulation}
...
\subsection{Doherty Architecture}
...
\subsection{Digital Predistortion (DPD)}
