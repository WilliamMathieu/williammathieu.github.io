% section: wiki_amplifiers
\section{RF Amplifiers}\label{sec:wiki_amplifiers}

\input{pedagogy/wiki_amplifiers_obj}
...
\subsection{Linearity: P1dB and IP3}
...
\input{pedagogy/wiki_amplifiers}
