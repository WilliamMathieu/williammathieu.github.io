% section: wiki_db_dbm
\section{Decibels, dBm and RF Power Units}\label{sec:wiki_db_dbm}

\input{pedagogy/wiki_db_dbm_obj}
...
\subsection{Why Logarithmic Scales?}
...
\subsection{Absolute Power: dBm and dBW}
...
\subsection{dB Arithmetic in Cascades}
...
\subsection{Noise Floor and kTB}
...
\subsection{Converting Back to Linear}
