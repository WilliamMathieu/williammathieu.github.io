% section: wiki_parallel_imaging
\section{Parallel Imaging}\label{sec:wiki_parallel_imaging}

\input{pedagogy/wiki_parallel_imaging_obj}
...
\input{pedagogy/wiki_parallel_imaging}
