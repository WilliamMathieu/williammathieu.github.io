...
\titleformat{\subsubsection}{\sffamily\bfseries\color{rfpurple!70}}{\thesubsubsection}{0.5em}{}
...
% per-chapter "Further reading" line (citations into the References list)
\newcommand{\furtherreading}[1]{\par\smallskip\noindent{\footnotesize\textbf{Further reading:}~#1}}
