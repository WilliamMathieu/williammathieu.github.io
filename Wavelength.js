...
document.getElementById('wl-btn').addEventListener('click', function() {
    ...
    var out = '\u03bb = ' + math.format(lam, {notation:'engineering', precision:5}) + ' m<br>'
            + '\u03bb/2 = ' + math.format(lam/2, {notation:'engineering', precision:5}) + ' m<br>'
            + '\u03bb/4 = ' + math.format(lam/4, {notation:'engineering', precision:5}) + ' m';
    document.getElementById('wl-out').innerHTML = out;
});
